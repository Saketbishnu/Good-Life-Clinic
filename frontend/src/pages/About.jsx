...
const About = () => {
  ...
  return (
    <div className="px-6 md:px-16 lg:px-28 py-12 text-white-800">
      
      {/* Heading */}
      <div className="text-center text-2xl md:text-3xl font-semibold text-white-800">
        <p>
          ABOUT <span className="text-white-800 font-medium">US</span>
        </p>
      </div>
      ...
      <div className="my-12 flex flex-col md:flex-row gap-12 items-center">
        ...
        {/* Text Section */}
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-sm text-white-800 leading-relaxed">
          <p>
            Welcome to <span className="font-semibold text-green-600">Good-Life-Clinic</span>, 
          ...
          {/* Vision Section */}
          <div>
            <b className="text-lg text-white-800">Our Vision</b>
            <p className="mt-2">
      ...
      <div className="my-16 text-center max-w-3xl mx-auto">
        <h2 className="text-xl md:text-2xl font-semibold text-green-600 mb-4">Our Mission</h2>
